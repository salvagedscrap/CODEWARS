...
// garden = 'gravel gravel rock gravel gravel gravel gravel 
...
function rakeGarden(garden) {
    ...
    //build an array of words
      let newArr=garden.trim().split(' ')
      
      //map array to switch anything to gravel except for gravel and rock
